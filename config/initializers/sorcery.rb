...
Rails.application.config.sorcery.configure do |config|
  ...
  #
  config.twitter.key = "13hF7tHEZKUvBL0j2bvLg"
  config.twitter.secret = "z9io8wuk3R8LaSs0DfdQKexQ3j1ONbfVWbNrkv8tE"
  config.twitter.callback_url = "http://0.0.0.0:3000/oauth/callback?provider=twitter"
  config.twitter.user_info_mapping = { :username => "username" }
  
  config.facebook.key = "213674642148674"
  config.facebook.secret = "e76f6036bfa1cb7f8c648c01a053c81a"
